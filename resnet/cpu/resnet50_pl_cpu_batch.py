...
from parallel_cpu import NeuronSimpleDataParallel
...
## Load model
model_neuron = NeuronSimpleDataParallel( '/home/ubuntu/infer_test/resnet50_sl_cpu.pt', num_neuron_cores, batch_size=batch_size  )
